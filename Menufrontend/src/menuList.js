...
const ViewMenu = () => {
  ...
  <Link to="/" style={{ color: '#F5F5F5', fontWeight: 'bold', textDecoration: 'none', width:'37px',height:'24px',fontSize:'16px'}}>HOME</Link>
<Link to="/create" style={{ color: '#F5F5F5', fontWeight: 'bold', textDecoration: 'none', width:'36px',height:'24px',fontSize:'16px' }}>MENU</Link>
<Link to="/login" style={{ color: '#F5F5F5', fontWeight: 'bold', textDecoration: 'none', width:'37px',height:'24px',fontSize:'16px' }}>LOGIN</Link>
<Link to="/signup" style={{ color: '#F5F5F5', fontWeight: 'bold', textDecoration: 'none' , width:'50px',height:'24px',fontSize:'16px'}}>SIGNUP</Link>
    ...
    <a href="#contact" style={{ cursor: 'pointer', color: '#fff', textDecoration: 'none' , width:'179px',height:'24px',fontSize:'16px'}}>CONTACT US</a>
        ...
        {isMobileMenuOpen && (
          <nav style={{
            ...
            <span onClick={() => navigate('/')} style={{ cursor: 'pointer', color: '#F5F5F5' }}>HOME</span>
            <Link to="/login" style={{ color: '#F5F5F5', fontWeight: 'bold', textDecoration: 'none' }}>LOGIN</Link>
            <Link to="/signup" style={{ color: '#F5F5F5', fontWeight: 'bold', textDecoration: 'none' }}>SIGNUP</Link>
            <Link to="/create" style={{ color: '#F5F5F5', fontWeight: 'bold', textDecoration: 'none' }}>MENU</Link>
